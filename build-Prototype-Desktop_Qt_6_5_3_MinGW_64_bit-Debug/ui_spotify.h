...
"border-radius: 15px;"));
        ...
        musicTimer->setGeometry(QRect(340, 690, 570, 22));
...
"}"));
        ...
        volumeSlider->setGeometry(QRect(1090, 690, 160, 22));
...
"}"));
        ...
        mute_button->setGeometry(QRect(1050, 685, 30, 30));
